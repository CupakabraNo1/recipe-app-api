...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test listo of recipes is limited to authenticated user."""
    ...
    def test_create_recipe_with_new_tag(self):
        """Test creatin a recipe with new tag."""
        payload = {
    ...
    def test_create_recipe_with_existing_tags(self):
        """Tes creating a recipe with existing tag."""
    ...
    def test_create_tag_on_update(self):
        """Test createing tag when updating a recipe"""
        recipe = create_recipe(user=self.user)
        payload = {
            'tags': [
                {'name': 'Lunch'}
    ...
    def test_aupdate_recipe_assign_tag(self):
    ...
    def test_create_recipe_with_existing_ingredinet(self):
        """Test creating a new recipe with existing ingredint."""
        ...
        for ingredientIterator in payload['ingredients']:
            exists = recipe.ingredients.filter(
                user=self.user,
                name=ingredientIterator['name']
            ).exists()
            self.assertTrue(exists)
